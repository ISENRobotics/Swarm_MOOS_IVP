...
OBSTACLE_POS1="{10,-80:10,-100:30,-100:30,-80}"
OBSTACLE_POS2="{100,-120:100,-130:130,-130:130,-120}"
OBSTACLE_POS3="{60,-145:60,-150:70,-150:70,-145}"
...
for i in `seq 1 $NB_ROBOT`; do
	...
	if [ $pair_impair = "0" ] ; 
		...
		then
			let "positionX = i * 15 - 40"
			MOTIF_POS="$positionX,-30" 
			let "positionX = i * 15 +100"
			STOP_POS="$positionX,-190" 
		
	    	else

			let "positionX = i * 15 - 40"
			MOTIF_POS="$positionX,-20"
			let "positionX = i * 15 + 100"
			STOP_POS="$positionX,-180"    
	fi
    ...
    START_POS=$START_POS MOTIF_POS=$MOTIF_POS STOP_POS=$STOP_POS OBSTACLE_POS1=$OBSTACLE_POS1 OBSTACLE_POS2=$OBSTACLE_POS2 OBSTACLE_POS3=$OBSTACLE_POS3 
